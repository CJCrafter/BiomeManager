...
public class BiomeWrapper_1_20_R3 implements BiomeWrapper {
    ...
    public BiomeWrapper_1_20_R3(Biome biome) {
    ...
    public BiomeWrapper_1_20_R3(NamespacedKey key, BiomeWrapper_1_20_R3 base) {
        Registry<Biome> biomes = MinecraftServer.getServer().registryAccess().registry(Registries.BIOME).orElseThrow();
