...
public class v1_20_R3 implements BiomeCompatibility {
    ...
    public v1_20_R3() {
        ...
        for (Biome biome : biomes) {
            ...
            try {
                ...
                BiomeRegistry.getInstance().add(key, new BiomeWrapper_1_20_R3(biome));
            } catch (Throwable ex) {
    ...
    public BiomeWrapper createBiome(NamespacedKey key, BiomeWrapper base) {
        return new BiomeWrapper_1_20_R3(key, (BiomeWrapper_1_20_R3) base);
    }
    ...
    public BiomeWrapper getBiomeAt(Block block) {
        ...
        if (wrapper == null)
            wrapper = new BiomeWrapper_1_20_R3(getBiome(key));
