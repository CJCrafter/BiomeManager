...
public class BiomeWrapper_1_21_R1 implements BiomeWrapper {
    ...
    public BiomeWrapper_1_21_R1(Biome biome) {
    ...
    public BiomeWrapper_1_21_R1(NamespacedKey key, BiomeWrapper_1_21_R1 base) {
        Registry<Biome> biomes = MinecraftServer.getServer().registryAccess().registry(Registries.BIOME).orElseThrow();
    ...
    public void setBase(org.bukkit.block.Biome biome) {
        Registry<Biome> biomes = MinecraftServer.getServer().registryAccess().registry(Registries.BIOME).orElseThrow();
        base = biomes.get(ResourceLocation.fromNamespaceAndPath(biome.getKey().getNamespace(), biome.getKey().getKey()));
