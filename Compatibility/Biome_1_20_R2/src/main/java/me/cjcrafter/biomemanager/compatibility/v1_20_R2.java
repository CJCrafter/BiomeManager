...
public class v1_20_R2 implements BiomeCompatibility {
    ...
    public v1_20_R2() {
        ...
        for (Biome biome : biomes) {
            ...
            try {
                ...
                BiomeRegistry.getInstance().add(key, new BiomeWrapper_1_20_R2(biome));
            } catch (Throwable ex) {
    ...
    public BiomeWrapper createBiome(NamespacedKey key, BiomeWrapper base) {
        return new BiomeWrapper_1_20_R2(key, (BiomeWrapper_1_20_R2) base);
    }
    ...
    public BiomeWrapper getBiomeAt(Block block) {
        ...
        if (wrapper == null)
            wrapper = new BiomeWrapper_1_20_R2(getBiome(key));
