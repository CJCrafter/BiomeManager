...
public class BiomeWrapper_1_20_R2 implements BiomeWrapper {
    ...
    public BiomeWrapper_1_20_R2(Biome biome) {
    ...
    public BiomeWrapper_1_20_R2(NamespacedKey key, BiomeWrapper_1_20_R2 base) {
        Registry<Biome> biomes = MinecraftServer.getServer().registryAccess().registry(Registries.BIOME).orElseThrow();
